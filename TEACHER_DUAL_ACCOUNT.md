# Skenario Guru Lintas-Workspace
...
| --- | --- | --- |
| Sari Wijaya | `guru.dual@equora.id` | `guru12345` |

Setelah login → /guru (workspace **SMA Cendekia Equora**). Gunakan **pemilih workspace**
...
| --- | --- | --- | --- |
| Adinda Maharani | `2025001` | `SEKOLAH` | `guru12345` |
| Bagas Pratama | `2025002` | `SEKOLAH` | `guru12345` |
| Cinta Lestari | `2025003` | `SEKOLAH` | `guru12345` |
| Dimas Nugroho | `2025004` | `SEKOLAH` | `guru12345` |
...
| Nama | NIS | Kode | Kata sandi |
| --- | --- | --- | --- |
| Gilang Ramadhan | `B001` | `BIMBEL` | `guru12345` |
| Hasna Aulia | `B002` | `BIMBEL` | `guru12345` |
| Irfan Maulana | `B003` | `BIMBEL` | `guru12345` |
| Jihan Salsabila | `B004` | `BIMBEL` | `guru12345` |
